    ...
    <div className="grid grid-cols-1 md:grid-cols-12 border">
      <div className="bg-gray-900 md:col-span-4 p-10 text-white">
        ...
        <h3 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
          Get In <span className="text-[#c1a78c]">Touch</span>
        </h3>
        ...
        <div className="flex items-center mt-5">
          <svg className="h-6 mr-2 text-[#c1a78c]" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 489.536 489.536" xmlnsXlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 489.536 489.536">
            <g>
              <g>
        ...
        <div className="flex items-center mt-5">
          <svg className="h-6 mr-2 text-[#c1a78c]" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60.002 60.002"  xmlSpace="preserve">
            <g>
        ...
        <div className="flex items-center mt-5">
          <svg className="h-6 mr-2 text-[#c1a78c]" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 300.988 300.988"  xmlSpace="preserve">
            <g>
              <g>

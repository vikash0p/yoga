    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          ...
          <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
            <form className="w-full">
              ...
              <div className="border bo p-2 focus-within sm:flex sm:items-center sm:gap-4">
                <input type="email" id="UserEmail" placeholder="Vikash752200@gmail.com" className="w-full bg-transparent py-3 outline-none " />
                <button className="mt-1 w-full bg-[#d4cbc2]  px-6 py-3 text-sm font-bold uppercase tracking-wide text-black transition-none hover:bg-[#d4cbc2]  sm:mt-0 sm:w-auto sm:shrink-0">
                  Sign Up
                </button>
              </div>
            </form>
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <a href="#" className=" transition hover:opacity-75"> Tattoo Design</a>
              </li>
              <li>
                <a href="#" className=" transition hover:opacity-75"> Tattoo Application </a>
              </li>
              <li>
                <a href="#" className=" transition hover:opacity-75"> Cover-Up Tattoos </a>
              </li>
              <li>
                <a href="#" className=" transition hover:opacity-75"> Tattoo Consultation </a>
              </li>
              <li>
                <a href="#" className=" transition hover:opacity-75"> Tattoo Aftercare </a>
              </li>
            </ul>
          </div>
          <div className="col-span-2 sm:col-span-1">
      ...
      <div className="mt-8 border-t  pt-8">
        <div className="sm:flex sm:justify-between">
          <p className="text-xs ">© 2022. Vikash. All rights reserved.</p>
